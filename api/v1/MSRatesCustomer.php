...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql3="UPDATE `table_details` SET `reservation`='Not Reserved' WHERE tableNo IN (SELECT table_details.tableNo FROM `table_details` JOIN dine_in_order ON dine_in_order.tableNo=table_details.tableNo WHERE dine_in_order.orderId=".$data->orderId.")";
