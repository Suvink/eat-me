...
require_once './controllers/admin/RetrievReportController.php';
$RetrieveReportController = new RetrievReportController();
...
<body>
    ...
    <section class="mt-1 pl-1 pr-1">
        ...
        <table id="myTable">
            ...
            <tbody>
                <?php
                $result = $RetrieveReportController->getRetrieveDetails($sDate,$endDate);
                while ($row = mysqli_fetch_assoc($result)) {
                ?>
                    <tr>
                        <form action="" method="POST">
                            <td style="text-align: center;"><?php echo $row['inventoryId']; ?></td>
                            <td  style="text-align: center;"><?php echo $RetrieveReportController->getItemName( $row['inventoryId']); ?></td>
                            <td  style="text-align: center;">
                                <?php echo $row['retrieve_quantity'];; ?>
                                <?php echo "(" . $RetrieveReportController->getUnitName($RetrieveReportController->getUnitId($row['inventoryId'])) . ")"; ?> </td>
                            <td  style="text-align: center;" ><?php echo $row['retrieved_date&time']; ?></td>
                        </form>
                    </tr>
                <?php
                }
